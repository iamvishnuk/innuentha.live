...
import { Sparkles, ChevronLeft, Search, X } from 'lucide-react';
...
type SidebarProps = {
  ...
  isLoading: boolean;
  handleSelectEventFromList: (data: TEventWithUser) => void;
};
    ...
    >
      ...
      <div className='scrollbar-thin scrollbar-thumb-neutral-200 dark:scrollbar-thumb-neutral-800 flex-1 space-y-3 overflow-y-auto px-4 pb-4'>
        {isLoading ? (
          ...
          events.map((event: TEventWithUser) => {
